...
*   **Core Probability** [[Probability]] [link](https://zacharynote.substack.com/p/probability-101)
    *   **Bayes' theorem**
...
*   **Distributions** [[Distributions]] [link](https://github.com/The-Pocket/PocketFlow-Tutorial-Video-Generator/blob/main/docs/stats/probability_distribution.md)
    *   Gaussian / Normal
...
*   **Information Theory** [colah.github](https://colah.github.io/posts/2015-09-Visual-Information/)
    *   **Entropy (Shannon)**  [you can also look here](https://medium.com/@_prinsh_u/understanding-shannon-entropy-and-kl-divergence-through-information-theory-e201b8279e62)
    *   **Cross-entropy**
    *   **KL divergence**  [you can also look here](https://medium.com/@_prinsh_u/understanding-shannon-entropy-and-kl-divergence-through-information-theory-e201b8279e62)
    *   Mutual information
...
*   **Markov Chains** [Ignore Markov Decision ](https://medium.com/@JhalylM/understanding-markov-models-6c631c4d8433)
    *   **Markov property**
    *   Transition matrix
    *   Stationary distribution [[Markov]]
    *   Ergodicity [[Markov]]
    *   n-th order Markov models [[Markov]]
*   **Hidden Markov Models (HMM)** [[Hidden Markov]]
...
*   **Text Preprocessing** [link](https://medium.com/@devangchavan0204/complete-guide-to-text-preprocessing-in-nlp-b4092c104d3e) [link](https://medium.com/@ChanakaDev/natural-language-processing-nlp-basics-e99ead9746b2)
    *   **Tokenization**
...
*   **Feature Representations**
    *   **Bag of Words (BoW)** [medium](https://medium.com/analytics-vidhya/fundamentals-of-bag-of-words-and-tf-idf-9846d301ff22) (ignore Word2Vec)
    *   **TF-IDF**  [use above link]
    *   N-gram features [use above link]
    *   One-hot encoding [medium](https://medium.com/@sateeshfrnd/breaking-down-one-hot-encoding-for-text-data-in-nlp-fdd8a8df60f4)
    *   Sparse vs dense vectors [medium](https://medium.com/@sateeshfrnd/breaking-down-one-hot-encoding-for-text-data-in-nlp-fdd8a8df60f4)
*   **Syntax & Parsing** [[Syntax and Parsing]]
    *   **POS tagging**
    *   Constituency parsing
    *   **Dependency parsing**
    *   CFG & CYK algorithm
    *   Chunking / shallow parsing
*   **Lexical Semantics** [[Lexical Sementics]]
    *   WordNet & synsets
    *   WSD (Word Sense Disambiguation)
    *   Coreference resolution
    *   Semantic role labeling
    *   Lexical overlap
*   **Classical ML for NLP** [[Classical ML for NLP]]
    *   Logistic regression 
...
*   **Static Embeddings** [[Static Embedding]]
...
*   **RNNs & Variants**
    ...
    *   **LSTM (cell, input, forget, output gates)** [use same blog]
    ...
    *   **Teacher forcing** [medium](https://medium.com/data-science/what-is-teacher-forcing-3da6217fed1c)
*   **CNNs for NLP ** [medium](https://medium.com/@conniezhou678/mastering-natural-language-processing-part-23-understanding-convolutional-neural-networks-cnns-98b4e434bba6) [can be ignored]
    *   1D convolutions over text
    *   **TextCNN (Kim 2014)**
    *   N-gram capture with filters
    *   Max-over-time pooling
*   **Attention Mechanisms** [medium](https://medium.com/@akanyaani/evolution-of-attention-mechanisms-in-nlp-from-additive-to-self-attention-01e265925899) [YT](https://www.youtube.com/watch?v=4vye3iUrR-g)
...
*   **Training Fundamentals**
    *   **Backprop through time (BPTT)** [YT](https://www.youtube.com/watch?v=4vye3iUrR-g)
    *   Gradient clipping [medium](https://medium.com/data-science/what-is-gradient-clipping-b8e815cdfb48) [medium](https://medium.com/@_prinsh_u/gradient-clipping-accumulation-and-more-essential-techniques-for-effective-training-c08f59c8b15d)
    *   Dropout & regularization  [medium](https://medium.com/@_prinsh_u/gradient-clipping-accumulation-and-more-essential-techniques-for-effective-training-c08f59c8b15d)
    *   Label smoothing [medium](https://medium.com/data-science/what-is-label-smoothing-108debd7ef06)
